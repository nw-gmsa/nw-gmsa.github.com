...
| Discrete variation analysis overall interpretation / Genomic Test Outcome | 51968-6                                            | [Genomic Test Outcome Codes](ValueSet-GenomicTestOutcomeCodes.html) and [Variant Assess](https://loinc.org/LL1971-2) | 1..1        | 1            | Observation.valueCodeableConcept <br/> Observation.dataAbsentReason / CNE | LA9633-4 (Present) / 431 (TARGET DETECTED AT A LEVEL REQUIRING CLINICAL ACTION) |
{:.grid}
