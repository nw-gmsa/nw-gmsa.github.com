...
diagnostic pathway, orchestrated through a haemato-oncology order comms system
(HODS) - see [Inter Laboratory Workflow (ILW)](ILW.html) for the generic
sub-order/reflex pattern this follows (`LAB-35`/`LAB-36`).
