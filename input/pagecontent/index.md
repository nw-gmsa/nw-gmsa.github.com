...
|----------------------------------------------------------|-----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
| Distributed WGS (dWGS)                                  | [dWGS](dWGS.html)                                                                    | [ILW - Sub-orders LAB-35/LAB-36](ILW.html#sub-orders-lab-35-and-lab-36)        | [dWGS Sub-Order Manifest](Questionnaire-dWGSSubOrder.html) under [Genomic Test Order](Questionnaire-GenomicTestOrder.html)                        |
| Histocompatibility and Immunogenetics                   | [Histocompatibility and Immunogenetics](HistocompatibilityAndImmunogenetics.html)    | [LTW - LAB-1 Process Flow](LTW.html#lab-1-process-flow) / [LAB-3 Process Flow](LTW.html#lab-3-process-flow) | [Histocompatibility Ask At Order Entry](Questionnaire-HistocompatibilityAskAtOrderEntry.html) under [Genomic Test Order](Questionnaire-GenomicTestOrder.html#order-entry-questions) / [Chimerism Result Panel](Questionnaire-ChimerismResultPanel.html) under [DiagnosticReport](StructureDefinition-DiagnosticReport.html) |
