...
| [Medical Record Number](StructureDefinition-MedicalRecordNumber.html) | 1..1                               | Task.for.identifier   | ServiceRequest.subject            | PID-2                         | P-Number |          |                  |
...
| Original Order/Referral Number (Placer)                               | 0..1                               |                       | ServiceRequest.basedOn.identifier |                               |          |          |                  |
| Original Order/Referral Number (Filler)                               | 1..1                               | Task.groupIdentifier  | ServiceRequest.basedOn.identifier |                               | R-Number |          |                  |
| Order Requester Name                                                  | 0..1                               | Task.requester        | ServiceRequest.requester          | ORC-12	Ordering Provider      |          |          |                  |
