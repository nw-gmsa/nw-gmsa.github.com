...
FHIR Reference introduces a `reference` to a detailed version of Organisation with additional elements. 
...
| Parent [Organisation Code](https://www.datadictionary.nhs.uk/attributes/organisation_code.html)                                                                                                                                                                           | Organization.partOf            | XON-8                                                                          | Inferred from OrganizationAffliation (codes RE5 and RE6) |
