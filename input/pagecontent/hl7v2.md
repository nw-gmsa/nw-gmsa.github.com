...
| PV1-10    | Hospital Service          |             | R <span class="badge badge-danger">S</span> | [Service](ValueSet-service.html)                                                               | 892761000000102^Clinical haematology service^SNM3<br/>810^Radiology^2.16.840.1.113883.2.1.6.8 |
...
| OBR-4     | Universal Service Identifier       |             | R <span class="badge badge-danger">S</span>                                           | [Genomic Test Directory](ValueSet-GenomicTestCodes.html)                    | R240.1^Diagnostic testing for known variant(s)^England-GenomicTestDirectory |
...
| OBX-6     | Units                        | [CE](#ce) | O                                           | [ucum-units](https://build.fhir.org/valueset-ucum-units.html) |                                                                                                                 |
| OBX-7     | References Range             | ST        | O                                           |                                                               |                                                                                                                 |
| OBX-8     | Abnormal Flags               | IS        | O                                           |                                                               |                                                                                                                 |
| OBX-11    | Observation Result Status    | ID        | R                                           |                                                               | F                                                                                                               |
...
| XON-3     | Id Number            | NM        | R           | [Organisation Code](StructureDefinition-OrganisationCode.html) <br/> [Organisation Site Code](StructureDefinition-OrganisationSiteIdentifier.html) when present XON-8 must be populated | R0A or R0A02                               |
...
| XON-8     | Assigning Facility   | HD        | O           | [Organisation Code](StructureDefinition-OrganisationCode.html)                                                                                                                          | R0A                                        |
{:.grid}
