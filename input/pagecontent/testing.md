...
```aiignore
 java -jar validator_cli.jar bundle.json -version 4.0.1 -ig package.tgz -bundle ServiceRequest:0 https://fhir.nwgenomics.nhs.uk/StructureDefinition/ServiceRequest -tx n/a
```

##### unsolicited-observation R01 Validation Example

```aiignore
 java -jar validator_cli.jar bundle.json -version 4.0.1 -ig package.tgz -bundle DiagnosticReport:0 https://fhir.nwgenomics.nhs.uk/StructureDefinition/DiagnosticReport -tx n/a
```
...
|                                                                 | STRETFORD                                     | Syrio    |             |                           | M          | 1992-05-29                 | &#9989;  2025-12-01                                                                 |                                                                                                                                                                                          |                       |                                 |                         |                            |                               |          |
{:.grid}
...
|---------------|----------------|----------|-------------|--------|----------------------------|----------|---------------------------|----------------|----------------|----------------|---------------------------|-------------------------------|----------|
| 999 999 9468  | EDITESTPATIENT | ONE      | John        | M      | 1925-01-27                 |          | D82015                    |                |                |                |                           |                               | B6 5RQ   |
| 999 999 9476  | EDITESTPATIENT | TWO      |             | M (F)  | 1962-02-01 (1964-02-29)    |          | B85023                    |                |                |                |                           |                               | EX6 7JJ  |
| 999 999 9484  | EDITESTPATIENT | THREE    | ZOE         | M (F)  | 2007-05-05  (1978-07-19)   |          | -                         |                |                |                |                           |                               | EX2 5SE  |
| 999 999 9492  | EDITESTPATIENT | FOUR     |             | M      | 1933-03-03 (1911-02-12)    |          | B85023                    |                |                |                |                           |                               | EX1 2SS  |
| 999 999 9506	 | EDITESTPATIENT | FIVE     | LESLIE      | M      | 1990-10-19                 |          |                           |                |                |                |                           |                               | LL1 1EQ  |
| 999 999 9514  | EDITESTPATIENT | SIX      |             | M      | 1988-01-14 (1960-06-24)    |          |                           |                |                |                |                           |                               | CV35 8DU |
| 999 999 9522	 | EDITESTPATIENT | SEVEN    |             | M      | 2007-05-05 (1945-01-01)    |          |                           |                |                |                |                           |                               | EX2 5SE  |
| 999 999 9530	 | EDITESTPATIENT | EIGHT    |             | M      | 1985-12-01 (1972-03-12)    |          |                           |                |                |                |                           |                               | Retest T |
| 999 999 9549  | EDITESTPATIENT | NINE     |             | F      | 2002-02-02 (1950-11-13)    |          | B85023                    |                |                |                |                           |                               | EX1 2SS  |
| 999 999 9557  | EDITESTPATIENT | TEN      |             | F      | 1980-01-01 (1960-03-22)    |          |                           |                |                |                |                           |                               | RG12 9AX |
| 999 999 9565	 | EDITESTPATIENT | ELEVEN   |             | F      | 2008-05-05 (1930-04-14)    |          |                           |                |                |                |                           |                               | BD16 1QB |
| 999 999 9573	 | EDITESTPATIENT | TWELVE   |             | F (M)  | 1963-05-05 (1964-01-01)    |          |                           |                |                |                |                           |                               | EX1 2SS  |
| 999 999 9581	 | EDITESTPATIENT | THIRTEEN |             | F      | 1960-01-01 (1930-05-14)    |          | B85023                    |                |                |                |                           |                               | EX2 5SE  |
| 999 999 9603	 | EDITESTPATIENT | FOURTEEN |             | M (F)  | 1984-11-06 (1939-07-05)    |          | B85023                    |                |                |                |                           |                               | ub4 0db  |
{:.grid}
...
|---------------------|------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|
| Development         |                                                                                          |                                                                                  |                                                                                                                          |
|                     | Genomics Regional Orchestration Engine (RIE)                                               | https://gen-tie-dev.nwgenomics.nhs.uk/gentiedev/ESB                              | See [Placer Order Management [LAB-1]](MQ.html) and [CapabilityStatement](https://10.165.194.216/gentiedev/ESB/metadata)  |
|                     | Genomics Regional Genomic Archiving and Communication System (IHE) <br/> Genomics Clinical Data Repository (CDR) | https://gen-tie-dev.nwgenomics.nhs.uk/irishealth/csp/healthshare/clinicaldatarepository/fhir/r4 | See [Query Existing Data [PCC-44]](QEDm.html)                                                                            |
| Integration Testing |                                                                                          |                                                                                  |                                                                                                                          |
|                     | Genomics Regional Orchestration Engine (RIE)                                                        | https://gen-tie-test.nwgenomics.nhs.uk/gentietest/ESB                            | See [Placer Order Management [LAB-1]](MQ.html) and [CapabilityStatement](https://10.165.194.217/gentietest/ESB/metadata) |
