...
| Ssp-InteractionID	                         | Spine’s Interaction ID. <br/> The interaction ID for retrieving a record referenced in an NRL pointer is a fixed value, specific to the NRL service: <br/> urn:nhs:names:services:nrl:DocumentReference.content.read | action and subtype         |                  |
