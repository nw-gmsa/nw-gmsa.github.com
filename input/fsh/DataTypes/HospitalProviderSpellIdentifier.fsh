...
- **HL7 FHIR** Encounter.identifier and EpisodeOfCare.identifier (type = VN)
...
This definition is compatible with [Yorkskhire and Humberside - Interweave-EncounterGrouping](https://fhir.interweavedigital.com/R4/StructureDefinition-Interweave-EncounterGrouping.html)
"""
