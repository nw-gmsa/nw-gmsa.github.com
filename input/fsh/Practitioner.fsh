...
Title:          "Practitioner"
Description:    """
Extension of UKCore Practitioner which includes elements from:
- HL7 v2 XCN – `Extended Composite ID Number and Name for Persons` definition from [NHS England HL7 v2 ADT Message Specification](https://drive.google.com/drive/folders/1FRkyZvWpZB1nCKbvQbo-eW_q9VtlR3Ws)
