...
* component[clinical-significance].valueCodeableConcept from http://loinc.org/vs/LL4034-6 (example)
* component[clinical-significance].valueCodeableConcept ^short = "Pathogenic | Likely pathogenic | Uncertain significance | Likely benign | Benign"
