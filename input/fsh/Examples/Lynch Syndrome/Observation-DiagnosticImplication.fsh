...
* component[=].valueCodeableConcept.coding[+] = $sct#716318002 "Lynch syndrome"
// SNOMED Validation issues * component[=].valueCodeableConcept.coding[+] = $sct#1365861003 "Lynch syndrome gene mutation detected"
