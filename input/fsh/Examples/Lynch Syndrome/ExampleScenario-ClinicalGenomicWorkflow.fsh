...
* process[+]
  ...
  * description = "This step creates the [Genomics Test Report](StructureDefinition-DiagnosticReport.html)"
...
* process[+]
  ...
  * description = "This step reviews the [Genomics Test Report](StructureDefinition-DiagnosticReport.html)"
...
* process[+]
  ...
  * description = "This step acts on the [Genomics Test Report](StructureDefinition-DiagnosticReport.html)"
