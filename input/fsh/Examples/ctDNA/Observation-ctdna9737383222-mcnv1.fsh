Instance: ctdna9737383222-mcnv1
InstanceOf: Variant
Title: "Variant - ctDNA Multigenic Copy Number Variant"
Description: """
Standalone extraction of the multi-gene-CNV `Observation` (Xq22.1-q28 deletion) from
...
* identifier[+].value = "ctdna9737383222-mcnv1"
...
* component[=].valueCodeableConcept = IGeneVariantCategory#MCNV "Multigenic Copy Number Variant"
...
* component[=].valueCodeableConcept.text = "Xq22.1-q28"
