...
* item[+]
  ...
  * item[+]
    ...
    * code[+] = $MFTEPIC#230016 "TEST TYPE (RARE DISEASE)"
    * text = "Test Type"
    * type = #choice
  ...
  * item[+]
    * linkId = "405824009"
    * code[+] = $sct#405824009 "Genetic test (procedure)"
    * code[+] = $MFTEPIC#230017 "TEST TYPE (SOLID CANCER)"
    * text = "Test Type"
    * type = #choice
    * answerValueSet = Canonical(GenomicRareAndInheritedDisease)
    * definition = "https://nw-gmsa.github.io/StructureDefinition/ServiceRequest#ServiceRequest.code"
  ...
  * item[+]
    * linkId = "230018"
    * code[+] = $sct#405824009 "Genetic test (procedure)"
    * code[+] = $MFTEPIC#230018 "TEST TYPE (HAEMATOLOGICAL ONCOLOGY)"
    * text = "Test Type"
    * type = #choice
    * answerValueSet = Canonical(GenomicRareAndInheritedDisease)
    * definition = "https://nw-gmsa.github.io/StructureDefinition/ServiceRequest#ServiceRequest.code"
  ...
  * item[+]
    * linkId = "114867"
    * code[+] = $MFTEPIC#114867 "NAME OF SUPERVISING CLINICIAN (CLC)"
...
* item[+]
  ...
  * type = #group
  * repeats = true
  * code[+] = $sct#123038009 "Specimen (specimen)"
  * item[+]
    * linkId = "113979"
    * code[+] = $MFTEPIC#113979 "SPECIMEN 1 SOURCE (BLOOD RESTRICTIONS)"
    * text = "Specimen Source"
    * type = #string
  * item[+]
    * linkId = "66746-9"
    * code[+] = $loinc#66746-9 "Specimen Type"
    * code[+] = $MFTEPIC#230001 "SPECIMEN TYPE"
  ...
  * item[+]
    * linkId = "230002"
    * code[+] = $MFTEPIC#230002 "SPECIMEN SOURCE"
    * text = "Specimen Source"
    * type = #string
  * item[+]
    * linkId = "230003"
  ...
  * item[+]
    * linkId = "230005"
    * code[+] = $MFTEPIC#230005 "SPECIMEN DESCRIPTION"
  ...
  * item[+]
    ...
    * code[+] = $MFTEPIC#230019 "HIGH INFECTION RISK"
  ...
  * item[+]
    ...
    * code[+] = $MFTEPIC#230037 "DNA SAMPLE STORED"
...
* item[+]
  ...
  * item[+]
    * linkId = "230023"
    * code[+] = $MFTEPIC#230022 "PROBAND OR FAMILY MEMBER"
  ...
  * item[+]
    ...
    * code[+] = $MFTEPIC#230027 "EMAIL ADDRESSES"
  ...
  * item[+]
    ...
    * code[+] = $MFTEPIC#230029 "CONFIRMATION OF CONSENT"
  ...
  * item[+]
    ...
    * item[+]
      ...
      * code[+] = $MFTEPIC#230032 "MACRODISSECTION REQUIREMENTS"
  ...
  * item[+]
    ...
    * item[+]
      ...
      * code[+] = $MFTEPIC#230034 "TEST RELATED TO PREGNANCY"
    ...
    * item[+]
      ...
      * code[+] = $MFTEPIC#230043 "REASON FOR RE-INTERPRETATION"
      * text = "Reason For Variant Re-Interpretation Request"
      * type = #string
    * item[+]
      * linkId = "230048"
      * code[+] = $MFTEPIC#230048 "GENETICS TEST"
      * text = "Please Select Clinical Indication(s)"
      * type = #string
    * item[+]
      * linkId = "230057"
      * code[+] = $MFTEPIC#230057 "PRE-NATAL GENETICS TEST LIST"
      * text = "Please Select Clinical Indication(s)"
      * type = #string
  ...
  * item[+]
    * linkId = "230035"
    * code[+] = $MFTEPIC#230035 "DECEASED INFANT"
  ...
  * item[+]
    * linkId = "230059"
    * code[+] = $MFTEPIC#230059 "MFT LAB GENETICS DUMMY"
    * text = "TEST"
    * type = #string

  * item[+]
    * linkId = "230060"
    * code[+] = $MFTEPIC#230060 "MFT LAB GENETICS DUMMY2"
    * text = "TEST2"
    * type = #string
  ...
  * item[+]
    ...
    * code[+] = $MFTEPIC#230061 "MFT LAB GENETICS R22 - ABNORMAL SCAN FINDINGS"
  ...
  * item[+]
    ...
    * code[+] = $MFTEPIC#230062 "MFT LAB GENETICS R401 - TRISOMY"
  ...
  * item[+]
    * linkId = "230064"
    * code[+] = $MFTEPIC#230064 "GENETICS - HAS PATIENT HAD TRANSPLANT"
  ...
  * item[+]
    * linkId = "230065"
    * code[+] = $MFTEPIC#230065 "GENETICS - WHAT TYPE OF TRANSPLANT?"
  ...
  * item[+]
    * linkId = "230066"
    * code[+] = $MFTEPIC#230066 "GENETICS - SUSPECTED LUNG CANCER"
  ...
  * item[+]
    * linkId = "230067"
    * code[+] = $MFTEPIC#230067 "GENETICS - CONFIRMED LUNG CANCER TISSUE"
  ...
  * item[+]
    * linkId = "230068"
    * code[+] = $MFTEPIC#230068 "GENETICS - ADVANCED LUNG CANCER STAGE"
    * text = "Please Select Advanced Stage Lung Cancer Stage"
    * type = #choice

  * item[+]
    * linkId = "230100"
    * code[+] = $MFTEPIC#230100 "MFT LAB GENETICS EXTRA TESTING FORM COMPLETED"
